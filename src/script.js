function changeLanguage() {
    ...
    const content = {
        it: {
            ...
            spid: "Inserisci lo SPID per continuare a navigare sul sito.",
        ...
        en: {
            ...
            spid: "Enter your SPID to continue browsing the site.",
        ...
        es: {
            ...
            spid: "Inserta tu SPID para continuar navegando en el sitio.",
    ...
    document.getElementById('spid').innerText = content[lang].spid;
